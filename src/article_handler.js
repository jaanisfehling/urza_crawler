...
export async function handleArticle(dbClient, absolute_url, headline, datetime, window) {
    if (!await urlExistsInDB(dbClient, absolute_url)) {
        ...
        await saveToDB(dbClient, absolute_url, headline, datetime, sanitizedHTML);
        try {
